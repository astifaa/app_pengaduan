<?php include'../layout/header_petugas.php'; ?>
                    ...
                    <tr>
                      ...
                      <td><i><?php echo $d['status']; ?><i></td>
                        <td>
                          ...
                          data-nik="<?php echo $d['nik']?>"
                          data-isi_laporan="<?php echo $d['isi_laporan']?>"
                          data-id_pengaduan="<?php echo $d['id_pengaduan']?>"
                ...
                <div class="modal-content">
                  ...
                  <form method="post" action="simpan_verifikasi.php">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="tgl_tanggapan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo date('yy-m-d') ?>" readonly>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="isi_laporan" class="form-control" id="isi_laporan" readonly>
                    </div>
                    <div class="mb-3">
