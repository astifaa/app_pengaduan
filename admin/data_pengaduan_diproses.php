      ...
      <div class="col-12">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Data Pengaduan Diproses</h3>
          </div>
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
                  ...
                  while($d = mysqli_fetch_array($spp)){
                    ...
                    <tr>
                      ...
                      <td><i><?php echo $d['status']; ?><i></td>
                        <td>
                          <a id="lihat_modal" href="#" type="button" class="btn btn-block btn-info btn-sm" data-toggle="modal" data-target="#isimodal" 
